...
export async function POST(request: NextRequest) {
  try {
    ...
    if (action === 'resend-otp') {
      ...
      try {
        ...
        // ✅ CORRECT: inviteUserByEmail resends verification
  ...
  role: 'resident',
  is_active: true,  // ✅ This exists in your schema
  // display_name removed ❌ This didn't exist
})
    ...
    try {
      // ✅ CORRECT: Use inviteUserByEmail to send verification
