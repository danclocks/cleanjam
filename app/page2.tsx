    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex gap-4">
              <button className="px-6 py-2 text-green-600 font-semibold hover:text-green-700 transition-smooth border-2 border-green-600 rounded-lg">
                Sign In
              </button>
              <button className="px-6 py-2 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition-smooth">
                Sign Up
              </button>
            </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden pb-4 border-t">
              ...
              <div className="flex flex-col gap-2 mt-4">
                ...
                <button className="px-6 py-2 text-green-600 font-semibold border-2 border-green-600 rounded-lg">
                  Sign In
                </button>
                </Link>
                <button className="px-6 py-2 bg-green-600 text-white font-semibold rounded-lg">
                  Sign Up
                </button>
              </div>
            </div>
      ...
      <section className="pt-28 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-green-50 via-blue-50 to-emerald-50">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-10 py-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-bold rounded-xl hover:shadow-xl transition-smooth flex items-center justify-center gap-2 text-lg shadow-lg">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-600 to-emerald-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button className="px-12 py-4 bg-white text-green-600 font-black rounded-xl hover:bg-gray-100 transition-smooth flex items-center justify-center gap-2 text-lg mx-auto shadow-lg">
